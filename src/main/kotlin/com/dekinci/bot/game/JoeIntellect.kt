...
class JoeIntellect(private val state: State) {
    fun chooseMove(): Move {

        // If there is a free river near a mine, take it!
        val try0 = state.riverMap.find { river ->
        ...
        val try1 = state.riverMap.find { river ->
